...
const news = [
  ...
  {
    title: "La Universidad Distrital abre sus puertas al conocimiento",
    description: "Explora las oportunidades académicas y experiencias que ofrece nuestra universidad.",
    image: "/image/hero.jpeg",
    alt: "Estudiante de la Universidad Distrital en una actividad académica",
  },
];
